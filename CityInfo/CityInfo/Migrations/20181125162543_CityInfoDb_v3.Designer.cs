...
namespace CityInfo.Migrations
{
    ...
    [Migration("20181125162543_CityInfoDb_v3")]
    partial class CityInfoDb_v3
    {
            ...
            modelBuilder.Entity("CityInfo.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, Description = "The one with the cathdral that was never really finished.", Name = "Antwerp" },
